...
void HariMain(void) {
    ...
    for (;;) {
        ...
        if (timerctl.count >= 0x1f4 /* 0xbbf81e00 */) {
            timer_adjust();
        }
        ...
        if (fifo8_status(&keyfifo) + fifo8_status(&mousefifo) + fifo8_status(&timerfifo) + fifo8_status(&timerfifo2) + fifo8_status(&timerfifo3) == 0) {
            ...
            if (fifo8_status(&keyfifo) != 0) {
                ...
                if (mouse_decode(&mdec, i) != 0) {
                    ...
                    boxfill8(buf_back, binfo->scrnx, COL8_008484, 32, 16, 32 + 8*15, 31);
                    ...
                    putfonts8_asc(buf_back, binfo->scrnx, 0, 0, COL8_FFFFFF, s);         /* Rewrite coordinates  */
